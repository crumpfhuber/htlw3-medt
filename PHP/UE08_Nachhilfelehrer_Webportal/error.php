<?php
$error_code = isset($_GET['error_code']) ? $_GET['error_code'] : (isset($_SERVER['REDIRECT_STATUS']) ? $_SERVER['REDIRECT_STATUS'] : "404");
...
<head>
    ...
    <meta name="keywords" content="Nachhilfe, Rumpfhuber, Bildung">
...
<body>
    ...
    <h3><?php echo $error_code_list[$error_code]; ?></h3>
